package com.dismar.myapp.repository;

import com.dismar.myapp.DismarservicesApp;
import com.dismar.myapp.config.Constants;
import com.dismar.myapp.config.audit.AuditEventConverter;
import com.dismar.myapp.domain.PersistentAuditEvent;
...
import static com.dismar.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
